...
fn test_all_outputs_are_different() {
    ...
    for (i, out1) in outputs.iter().enumerate() {
        for (j, out2) in outputs.iter().enumerate() {
            if i != j {
                assert_ne!(out1, out2, "Test cases {} and {} produced identical hashes", i, j);
            }
        }
    }
}
...
fn test_large_input() {
    ...
    let expected = [
        0xc4, 0x14, 0x53, 0x64, 0xa3, 0xba, 0x46, 0x00,
        0x2f, 0xb1, 0x42, 0x42, 0x87, 0x2f, 0x79, 0x55,
        0x35, 0xba, 0xe6, 0x73, 0x8b, 0x1e, 0x47, 0xba,
        0x21, 0xeb, 0x40, 0x5c, 0xfd, 0xf8, 0x20, 0xa5,
    ];
...
fn test_unicode_input() {
    ...
    let expected = [
        0x7d, 0xe2, 0xf0, 0x64, 0x98, 0xb5, 0xb4, 0xd5,
        0x3b, 0x17, 0x00, 0x00, 0xc3, 0x11, 0x10, 0x1b,
        0x55, 0x04, 0x6a, 0x3c, 0x88, 0x9e, 0xfd, 0x54,
        0x35, 0x1c, 0xb3, 0x69, 0x7f, 0xcf, 0x57, 0xcc,
    ];
    assert_eq!(&output, &expected);
}
...
#[test]
fn test_alignment() {
    let mut unaligned_vec = vec![0u8; 33];
